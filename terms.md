...
- If you are under the age of majority where you live, you may use the Service only with the permission of a parent or legal guardian, who agrees to these Terms on your behalf.
...
- We may make the Service available only in certain countries or regions.

## 2. Your Account

- You sign in to Peppa with Sign in with Apple. You are responsible for all activity on your account and for keeping your Apple Account secure.
- Each person may have only one account. You may not create an account to get around a suspension, a ban, or another user's block.
- Your display name and handle must not impersonate anyone, mislead others about your identity or affiliation, or infringe anyone's rights. We may change or reclaim a display name or handle that violates these Terms.

## 3. Deleting Your Account

- You can delete your account at any time from within the app.
- When you delete your account, we delete your profile and the content associated with it, including your game library, completion records, ratings, reviews, comments, likes, lists and votes, follows, blocks, and game requests. Deletion may take some time to complete. Residual copies may remain in backups for a limited period, or where we are required to keep them by law.
- Some data is stored only on your device (for example, items saved to Later and games you add manually). We do not store this data on our servers. It stays on your device until you delete it or delete the app.
- Deleting the app does not delete your account. Deleting your account does not cancel a subscription purchased through the App Store (see Section 5).
...
"User Content" means anything you post or submit through the Service, including reviews, ratings, comments, lists and their names and descriptions, display names, avatars, and game requests and their comments.

- **You own your User Content.** You grant Peppa a worldwide, non-exclusive, royalty-free license to host, store, reproduce, display, adapt (for example, to format or resize), and distribute your User Content only as needed to operate and provide the Service. This license ends when you delete the content or your account, except for copies we must keep by law.
- **What other users can see.** The following are visible to other Peppa users: your profile (display name, handle, and avatar); your game library, except games you mark as archived; your completion records on beaten games, including completion dates, ratings, and short comments; reviews you post; comments; lists and votes; and your follows. Game requests are visible only to the recipient.
- **You are responsible for your User Content.** You must have the rights needed to post it. Reviews should reflect your honest experience. If you received a game for free or were paid to review it, disclose that.
- We do not endorse User Content. We have no obligation to monitor it, but we may review, hide, or remove it at our discretion.

## 7. Community Guidelines

**Peppa has zero tolerance for objectionable content and abusive users.** You must not post content or behave in a way that:

- harasses, bullies, threatens, or intimidates anyone, or encourages self-harm or suicide;
- attacks or demeans people based on race, ethnicity, national origin, religion, disability, disease, age, sex, sexual orientation, gender identity, or other protected characteristics;
- is sexually explicit or pornographic;
- sexualizes or endangers minors in any way (we report such content to the appropriate authorities);
- promotes violence, terrorism, or illegal activity;
- is spam, a scam, or unauthorized advertising, or manipulates ratings, reviews, likes, or votes (for example, with fake accounts or paid reviews);
- impersonates any person or organization, or misrepresents your affiliation with them;
- infringes anyone's intellectual property, privacy, or publicity rights, or shares someone's personal information without permission;
- contains malware, or attempts to disrupt, hack, scrape, or reverse engineer the Service;
- tries to get around our content filters, another user's block, or a suspension or ban.

Please warn others before sharing major spoilers. Content with unmarked spoilers may be hidden. We use automated filters that may prevent certain words from being posted.
...
- The Service, including its software, design, and the Peppa name and logo, is owned by the Peppa Team or its licensors.
- Subject to these Terms, we grant you a limited, non-exclusive, non-transferable, revocable license to use the app on Apple-branded devices that you own or control, as permitted by the App Store Usage Rules.
- You may not copy, modify, distribute, sell, or lease any part of the Service, or reverse engineer it, except where the law allows this despite this restriction.
- If you send us feedback or suggestions, we may use them without any obligation to you.

## 10. Third-Party Services and Links

The Service relies on and links to third-party services, such as Apple, Google Firebase, IGDB, RevenueCat, and external game stores. Your use of those services is subject to their own terms. We are not responsible for third-party services or their content.

## 11. Disclaimers

To the extent permitted by law, the Service is provided "as is" and "as available," without warranties of any kind, express or implied, including warranties of merchantability, fitness for a particular purpose, and non-infringement. We do not guarantee that the Service will be uninterrupted or error-free, that game information is accurate or complete, or that User Content is accurate or appropriate. Nothing in these Terms excludes warranties that cannot be excluded under applicable law.
...
To the extent permitted by law, you agree to compensate Peppa for losses and costs (including reasonable legal fees) arising from third-party claims caused by your User Content or your violation of these Terms.
...
- These Terms are between you and the Peppa Team only, not Apple Inc. ("Apple"). The Peppa Team, not Apple, is solely responsible for the app and its content.
- Your license to use the app is limited to use on Apple-branded products that you own or control, as permitted by the App Store Usage Rules. The app may also be accessed by other accounts associated with you through Family Sharing or volume purchasing, where applicable.
...
- The Peppa Team, not Apple, is responsible for addressing any claims relating to the app, including product liability claims, claims that the app fails to meet legal or regulatory requirements, and claims under consumer protection, privacy, or similar laws.
- If a third party claims that the app or your use of it infringes their intellectual property rights, the Peppa Team, not Apple, is responsible for investigating, defending, settling, and resolving the claim.
